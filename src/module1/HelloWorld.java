...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map2 = new UnfoldingMap(this, 425, 50, 325, 500, new Google.GoogleSimplifiedProvider());
		map2.zoomAndPanTo(zoomLevel, new Location(-23.6f, -46.6f));
